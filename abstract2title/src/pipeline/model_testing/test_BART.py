...
from src.data.data import abstract_title_pairs_to_pandas, fetch_papers_for_training
...
for _ in range(5):
    ...
    output_ids = model.generate(
        inputs["input_ids"].to(model.device), max_length=128, num_beams=4, early_stopping=True
    )
