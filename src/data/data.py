...
def load_arxiv_metadata(filename, n_papers, random_select=False, categories_filter=None):
    ...
    with open(filename, 'r') as file:
        ...
        if categories_filter:
            ...
            filtered_lines = [line for line in lines if categories_filter in json.loads(line).get('categories', '')]
...
def load_arxiv_metadata_into_db(filename, n_papers, random_select=False, db_name='arxiv_papers.db', root_dir='datasets'):
    """
    ...
    with open(filename, 'r') as file:
        ...
        for line in selected_lines:
            ...
            c.execute('''INSERT INTO papers(title, abstract, journal_ref, categories)
                         VALUES(?, ?, ?, ?)''', (title, abstract, journal_ref, categories))
